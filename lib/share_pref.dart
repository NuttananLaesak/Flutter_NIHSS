class Patient {
  ...
  final String? rtpa;
  final int scoreNoDisease;
  final int scoreDiabetes;
  final int scoreHypertension;
  final int scoreDyslipidemia;
  final int scoreStroke;
  final int scoreAtrialFibrillation;
  final int socreOtherDiseas;
  final String selectedNoDisease;
  final String selectedDiabetes;
  final String selectedHypertension;
  final String selectedDyslipidemia;
  final String selectedStroke;
  final String selectedAtrialFibrillation;
  final String selectedOtherDisease;
  ...
  Patient(
      ...
      required this.rtpa,
      required this.scoreNoDisease,
      required this.scoreDiabetes,
      required this.scoreHypertension,
      required this.scoreDyslipidemia,
      required this.scoreStroke,
      required this.scoreAtrialFibrillation,
      required this.socreOtherDiseas,
      required this.selectedNoDisease,
      required this.selectedDiabetes,
      required this.selectedHypertension,
      required this.selectedDyslipidemia,
      required this.selectedStroke,
      required this.selectedAtrialFibrillation,
      required this.selectedOtherDisease});
  ...
  factory Patient.fromMap(Map<String, dynamic> map) {
    return Patient(
        ...
        diastolicBloodPressureController:
            map['diastolicBloodPressureController'],
        ...
        rtpa: map['rtpa'],
        scoreNoDisease: map['scoreNoDisease'],
        scoreDiabetes: map['scoreDiabetes'],
        scoreHypertension: map['scoreHypertension'],
        scoreDyslipidemia: map['scoreDyslipidemia'],
        scoreStroke: map['scoreStroke'],
        scoreAtrialFibrillation: map['scoreAtrialFibrillation'],
        socreOtherDiseas: map['socreOtherDiseas'],
        selectedNoDisease: map['selectedNoDisease'],
        selectedDiabetes: map['selectedDiabetes'],
        selectedHypertension: map['selectedHypertension'],
        selectedDyslipidemia: map['selectedDyslipidemia'],
        selectedStroke: map['selectedStroke'],
        selectedAtrialFibrillation: map['selectedAtrialFibrillation'],
        selectedOtherDisease: map['selectedOtherDisease']);
  }
}
